class IP_DLG_SHOP_MISSIONS
{
    ...
    class Controls
    {
		...
		class IP_FRM_SHOP_MAIN: IP_RscFrame
		{
			idc = 1800;
		...
		class IP_BTN_SHOP_CLOSE: IP_RscButton
		{
			idc = 1600;
		...
		class IP_PIC_SHOP_PROFILE: IP_RscPicture
		{
			idc = 1200;
		...
		class IP_TXT_SHOP_NAME: IP_RscText
		{
			idc = 1000;
		...
		class IP_TXT_SHOP_RANK: IP_RscText
		{
			idc = 1001;
		...
		class IP_TXT_SHOP_MONEY: IP_RscText
		{
			idc = 1002;
		...
		class IP_TXT_SHOP_LABEL_INSERTION: IP_RscText
		{
			idc = 1003;
		...
		class IP_LSB_SHOP_MISSIONS: IP_RscListBox
		{
			idc = 1500;
		...
		class IP_STX_SHOP_MISSION: IP_RscStructuredText
		{
			idc = 1100;
		...
		class IP_BTN_SELECTMISSION: IP_RscButton
		{
			idc = 1601;
		...
		class IP_CMB_SHOP_NAVIGATION: IP_RscCombo
		{
			idc = 2100;
			x = 0.561875 * safezoneW + safezoneX;
		...
		class IP_TXT_SHOP_LABEL_NAVIGATION: IP_RscText
		{
			idc = 1004;
		...
		class IP_CMB_SHOP_INSERTION: IP_RscCombo
		{
			idc = 2101;
			x = 0.561875 * safezoneW + safezoneX;
		...
		class IP_BTN_SHOP_INSERT: IP_RscButton
		{
			idc = 1602;
...
class IP_DLG_SHOP_ITEMS
{
	...
	class Controls
	{
		...
		class IP_FRM_SHOP_CATEGORY: IP_RscFrame
		{
			idc = 1800;
		...
		class IP_LSB_SHOP_ITEMS_LEFT: IP_RscListBox
		{
			idc = 1500;
		...
		class IP_BTN_SHOP_PURCHASE: IP_RscButton
		{
			idc = 1601;
		...
		class IP_TXT_SHOP_ITEMS_LEFT: IP_RscText
		{
			idc = 1004;
			text = "Shop Items Left"; //--- ToDo: Localize;
			x = 0.304062 * safezoneW + safezoneX;
		...
		class IP_LSB_SHOP_ITEMS_RIGHT: IP_RscListBox
		{
			idc = 1501;
		...
		class IP_TXT_SHOP_ITEMS_RIGHT: IP_RscText
		{
			idc = 1005;
			text = "Shop Items Right"; //--- ToDo: Localize;
			x = 0.505156 * safezoneW + safezoneX;
		...
		class IP_STX_SHOP_INFO: IP_RscStructuredText
		{
			idc = 1100;
		...
		class IP_TXT_SHOP_NAVIGATION_LABEL: IP_RscText
		{
			idc = 1000;
			text = "Navigation:"; //--- ToDo: Localize;
		...
		class IP_CMB_SHOP_FILTER: IP_RscCombo
		{
			idc = 2101;
		...
		class IP_TXT_SHOP_LABEL_FILTER: IP_RscText
		{
			idc = 1001;
			text = "Filter:"; //--- ToDo: Localize;
		...
		class IP_BTN_SHOP_SELL: IP_RscButton
		{
			idc = 1602;
		...
		class IP_BTN_SHOP_FUNCTION: IP_RscButton
		{
			idc = 1603;
		...
		class IP_TXT_SHOP_LABEL_FUNDS: IP_RscText
		{
			idc = 1002;
		...
		class IP_TXT_SHOP_FUNDS: IP_RscText
		{
			idc = 1003;
...
class IP_DLG_AMOUNT
{
    ...
    class Controls
    {
		...
		class IP_FRM_AMOUNT: IP_RscFrame
		{
			idc = 1800;
		...
		class IP_TXT_HOWMANY: IP_RscText
		{
			idc = 1000;
		...
		class IP_TXT_MAGAZINE: IP_RscText
		{
			idc = 1001;
		...
		class IP_SLD_AMOUNT: IP_RscSlider
		{
			idc = 1900;
		...
		class IP_BTN_OKAY: IP_RscButton
		{
			idc = 1600;
		...
		class IP_TXT_AMOUNT: IP_RscText
		{
			idc = 1004;
			text = "Amount: "; //--- ToDo: Localize;
			x = 0.371094 * safezoneW + safezoneX;
...
class IP_DLG_INSERT
{
    ...
    class Controls
    {
		...
		class IP_FRM_INSERT: IP_RscFrame
		{
			idc = 1800;
			x = 0.371093 * safezoneW + safezoneX;
			y = 0.379 * safezoneH + safezoneY;
		...
		class IP_TXT_LABEL_TO: IP_RscText
		{
			idc = 1000;
		...
		class IP_TXT_LABEL_BY: IP_RscText
		{
			idc = 1001;
		...
		class IP_TXT_LABEL_SIZE: IP_RscText
		{
			idc = 1004;
		...
		class IP_TXT_LABEL_CAPACITY: IP_RscText
		{
			idc = 1006;
		...
		class IP_TXT_CAPACITY: IP_RscText
		{
			idc = 1007;
